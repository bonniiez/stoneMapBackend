...
import com.stonemap.app.StoneMapBackendApp;
import com.stonemap.app.domain.Authority;
import com.stonemap.app.domain.User;
import com.stonemap.app.repository.AuthorityRepository;
...
import com.stonemap.app.service.dto.PasswordChangeDTO;
import com.stonemap.app.web.rest.errors.ExceptionTranslator;
import com.stonemap.app.web.rest.vm.KeyAndPasswordVM;
import com.stonemap.app.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = StoneMapBackendApp.class)
